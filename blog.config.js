...
const BLOG = {
  TITLE: process.env.NEXT_PUBLIC_TITLE || '陈鲲', // 站点标题
  DESCRIPTION: process.env.NEXT_PUBLIC_DESCRIPTION || '小镇青年', // 站点描述
  AUTHOR: '陈鲲', // 作者
  BIO: '在北京奋斗的南京小镇青年', // 作者简介
  LINK: 'chenkun.xyz', // 网站地址
  KEYWORDS: 'PhD, 光学, 游戏', // 网站关键词 英文逗号隔开
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'cb8088cff3274d6ba55238a884ade9c1', // Important page_id！！！Duplicate Template from  https://www.notion.so/tanghh/02ab3b8678004aa69e9e415905ef32a5
  ...
  CONTACT_EMAIL: 'kchen@iphy.ac.cn',
  CONTACT_WEIBO: '',
  CONTACT_TWITTER: 'https://twitter.com/chenkun2',
  CONTACT_GITHUB: 'https://github.com/chancenju',
  CONTACT_TELEGRAM: '',

  // 评论互动 可同时开启 CUSDIS UTTERRANCES GITALK
  COMMENT_CUSDIS_APP_ID: process.env.NEXT_PUBLIC_COMMENT_CUSDIS_APP_ID || '9f6bbf29-203d-4dd0-8985-9386745cf360', // data-app-id 36位 see https://cusdis.com/
